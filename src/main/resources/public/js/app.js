(function() {
	...
	app.config(function($stateProvider, $urlRouterProvider, $controllerProvider){
		...
		$stateProvider
			...
			.state('routes',{
	        url:'/routes',
	        templateUrl: viewsPrefix + 'routes.html',
	        controller:'RouteListController'
	    }).state('viewRoute',{
	       url:'/routes/:id/view',
	       templateUrl: viewsPrefix + 'route-view.html',
	       controller:'RouteViewController'
	    }).state('newRoute',{
	        url:'/routes/new',
	        templateUrl: viewsPrefix + 'route-add.html',
	        controller:'RouteCreateController'
	    }).state('editRoute',{
	        url:'/routes/:id/edit',
	        templateUrl: viewsPrefix + 'route-edit.html',
